...
async function columnRight() {
	...
	if (elements[elements.length - 2][0].role == "commander") {
		...
		if (
			elements[elements.length - 2][elements[elements.length - 2].length - 1]
				.role == "commander"
		) {
...
async function columnLeft() {
	...
	if (elements[elements.length - 2][0].role == "commander") {
		...
		if (
			...
			turnLeft(elements[elements.length - 4][0]);
			forwardHalfStep(elements[elements.length - 4][0]);
			forwardMarch(formation[9]);
			forwardHalfStep(elements[elements.length - 4][1]);
			forwardHalfStep(elements[elements.length - 4][2]);
			turnHalfLeft(elements[elements.length - 2 /*hi*/][0]);
			forwardMarch(elements[elements.length - 2 /*hi*/][0]);
			forwardMarch(elements[elements.length - 2 /*hi*/][1]);
			forwardMarch(elements[elements.length - 2 /*hi*/][2]);
			...
			forwardMarch(elements[elements.length - 2 /*hi*/][0]);
			forwardMarch(elements[elements.length - 2 /*hi*/][1]);
			turnHalfLeft(elements[elements.length - 2 /*hi*/][1]);
			forwardMarch(elements[elements.length - 2 /*hi*/][2]);
			forwardMarch(elements[elements.length - 3][0]);
			turnHalfLeft(elements[elements.length - 3][0]);
			forwardMarch(elements[elements.length - 3][1]);
			...
			await sleep(500);
			forwardHalfStep(elements[elements.length - 4][1]);
			turnLeft(elements[elements.length - 4][1]);
			forwardHalfStep(elements[elements.length - 4][2]);
			forwardMarch(elements[elements.length - 2 /*hi*/][0]);
			turnHalfLeft(elements[elements.length - 2 /*hi*/][0]);
			forwardMarch(elements[elements.length - 2 /*hi*/][1]);
			forwardMarch(elements[elements.length - 2 /*hi*/][2]);
			turnHalfLeft(elements[elements.length - 2 /*hi*/][2]);
			forwardMarch(elements[elements.length - 3][0]);
			forwardMarch(elements[elements.length - 3][1]);
			forwardMarch(elements[elements.length - 3][2]);
			turnHalfLeft(elements[elements.length - 3][1]);
			...
			turnHalfLeft(elements[elements.length - 2 /*hi*/][2]);
			turnHalfLeft(elements[elements.length - 3][2]);
			turnLeft(elements[elements.length - 4][2]);
			await sleep(500);
			// 9
			forwardHalfStep(elements[elements.length - 4][0]);
			forwardHalfStep(elements[elements.length - 4][1]);
			...
			forwardHalfStep(elements[elements.length - 3][1]);
			forwardHalfStep(elements[elements.length - 3][2]);
			forwardHalfStep(elements[elements.length - 2 /*hi*/][0]);
			forwardHalfStep(elements[elements.length - 2 /*hi*/][1]);
			forwardHalfStep(elements[elements.length - 2 /*hi*/][2]);
			forwardMarch(formation[9]);
			await sleep(500);
			// 10
			forwardHalfStep(elements[elements.length - 4][0]);
			...
			forwardHalfStep(elements[elements.length - 3 /**/][1]);
			forwardHalfStep(elements[elements.length - 3 /**/][2]);
			turnHalfLeft(elements[elements.length - 1][0]);
			forwardMarch(elements[elements.length - 1][0]);
			forwardMarch(elements[elements.length - 1][1]);
			forwardMarch(elements[elements.length - 1][2]);
			turnHalfLeft(elements[elements.length - 2][0]);
			forwardMarch(elements[elements.length - 2][0]);
			forwardMarch(elements[elements.length - 2][1]);
			forwardMarch(elements[elements.length - 2][2]);
			...
			forwardMarch(elements[elements.length - 1][0]);
			forwardMarch(elements[elements.length - 1][1]);
			turnHalfLeft(elements[elements.length - 1][1]);
			forwardMarch(elements[elements.length - 1][2]);
			forwardMarch(elements[elements.length - 2][0]);
			turnHalfLeft(elements[elements.length - 2][0]);
			forwardMarch(elements[elements.length - 2][1]);
			...
			forwardMarch(elements[elements.length - 1][1]);
			forwardMarch(elements[elements.length - 1][2]);
			turnHalfLeft(elements[elements.length - 1][2]);
			forwardMarch(elements[elements.length - 2][0]);
			forwardMarch(elements[elements.length - 2][1]);
			forwardMarch(elements[elements.length - 2][2]);
			turnHalfLeft(elements[elements.length - 2][1]);
...
async function openRanksMarch() {
	if (
		checkMove == 1 &&
		(Math.abs(formation[9].x - formation[3].x) ||
			Math.abs(formation[9].y - formation[3].y)) > 2
	) {
...
async function closeRanksMarch() {
	if (
		checkMove == 1 &&
		(Math.abs(formation[3].x - formation[5].x) ||
			Math.abs(formation[3].y - formation[5].y) ||
			Math.abs(formation[7].x - formation[1].x) ||
			Math.abs(formation[7].y - formation[5].y)) > 4
	) {
		let formationByRows = findRows();
...
4; //I do not know how or why this got here but it isn't erroring so it stays
